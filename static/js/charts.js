...
function buildCharts(sample) {
  ...
  var IDArray = allSampleID.filter(sampleObj => sampleObj.id == sample);
    ...
    //Create a variable that filters the metadata array for the object in the array whose id property matches the ID number
  ...
  // Create the layout for the bubble chart with title, a label for the x-axis, margins, and the hovermode property.
  var bubbleLayout = {
  ...
  //Use the Plotly function to plot the trace object and layout.
  Plotly.newPlot("bubble", bubbleData, bubbleLayout)
  
  // Create the trace object for the gauge chart.
  var gaugeData = [
    {
      type: "indicator",
      mode: "gauge+number",
  ...
  //Use Plotly function to plot the trace object and layout.
